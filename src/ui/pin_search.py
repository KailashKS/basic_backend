...
@app.get("/getPinnedSearch/", response_model=List[_schemas.DataaiSearch])
...
@app.post("/pinSearch/", response_model=_schemas.DataaiSearch)
...
@app.post("/unpinSearch/", response_model=_schemas.DataaiSearch)
